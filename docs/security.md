...
- Current anchor values are digests over observed cloud instance IDs, Kubernetes node identities, matched Siemens IED certificate-chain runtime evidence, or the local Windows `MachineGuid` registry value, not raw IDs.
